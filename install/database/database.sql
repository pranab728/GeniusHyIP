...
--
-- Host: 127.0.0.1
-- Generation Time: May 12, 2022 at 11:46 AM
...
(3, 'Withdraw', 'Your withdraw is completed successfully.', '<p>Hello {customer_name},<br>Your withdraw is completed successfully.</p><p>Thank You<br></p>', '<p>Hello {customer_name},<br>Your withdraw is completed successfully.</p><p>Thank You<br></p>', 1),
(4, 'Deposit', 'You have invested successfully.', '<p>Hello {customer_name},<br>You have deposited successfully.</p><p>Transaction ID:&nbsp;<span style=\"color: rgb(33, 37, 41);\">{order_number}.</span></p><p>Thank You.</p>', '<p>Hello {customer_name},<br>You have deposited successfully.</p><p>Transaction ID:&nbsp;<span style=\"color: rgb(33, 37, 41);\">{order_number}.</span></p><p>Thank You.</p>', 1),
(5, 'Invest', 'Your invest successfully completed.', '<p>Hello {customer_name},<br>Your invest successfully completed.</p><p>Thank You<br></p>', '<p>Hello {customer_name},<br>Your invest successfully completed.</p><p>Thank You<br></p>', 1);
...
(29, NULL, NULL, NULL, 'Block.io (BTC)', 'automatic', '{\"blockio_api_btc\":\"fae9-e6f5-7d05-df07\",\"text\":\"Pay via your Block.io (BTC) account.\"}', 'block.io.btc', '0', 1),
(30, NULL, NULL, NULL, 'Block.io (LTC)', 'automatic', '{\"blockio_api_ltc\":\"642a-48dc-4e31-31f6\",\"text\":\"Pay via your Block.io (BTC) account.\"}', 'block.io.ltc', '0', 1),
(31, NULL, NULL, NULL, 'Block.io (DGC)', 'automatic', '{\"blockio_api_dgc\":\"e586-cdb2-d54e-be26\",\"text\":\"Pay via your Block.io (BTC) account.\"}', 'block.io.dgc', '0', 1);
...
(86, 'Jenifer', 'santiago', '1649579858team8.jpg', '1230', 'Dhaka', 'road-04', '0123456789', '0900000', 'user@gmail.com', '$2y$10$LqhGTU515S1spyxHNEyYpO90oahOwFkh9x5XQHmq3qEJnSKwZA.VS', '4hxlvqgYs16PVOftAfqm1ATQInAcLzkq7wKFJlJt6OmL4LjU5j2wI51Ej7Wr', 0, 0, '759f1706acfd7bc23f6b95ae35d0fd8e', 'Yes', 9500, 0.3, '3266dcfa238c067719a09f1eabc4e1b4', 0, 0, NULL, 1, NULL, 1, '{\"full_name\":[\"Dark Loard\",\"text\"],\"nid\":[\"sSHjM9SA1649656607.jpg\",\"file\"],\"present_address\":[\"road-04\",\"textarea\"],\"parmanent_address\":[\"d\",\"textarea\"]}', NULL, 0, NULL, '2022-04-24 08:04:02');
...
--
ALTER TABLE `notifications`
  MODIFY `id` int(191) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=176;
...
--
ALTER TABLE `transactions`
  MODIFY `id` int(191) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=192;
...
--
ALTER TABLE `user_notifications`
  MODIFY `id` int(191) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
