...
class CoinPaymentController extends Controller
{
    ...
    public function deposit(Request $request)
    {
        ...
        $coin_public = 'ff615d014796ad3f89ea77116909fd3950013d1c77392339d0df418c64e6468e';
        $coin_private = '867F6E405d0f745b8a13d5296442c6cac438048e58CAc91BC7E6Ae961DfD1FFD';
        ...
        $my_callback_url = url('/').'/coinpay/notify?transx_id='.$item_number.'&secret='.$secret;
            ...
            $req = array(
                ...
                'custom' => $item_number,
                'ipn_url' => 'https://webhook.site/bf16d8c9-ac0e-4e47-acff-3a0ef0286149',
            );
