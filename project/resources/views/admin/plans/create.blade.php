      ...
      <div class="card-body py-5">
        ...
        <form class="geniusform" action="{{route('admin.plans.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group" id="fixedAmount">
              ...
              <input type="number" class="form-control" id="inp-fixed_amount" name="fixed_amount"  placeholder="{{ __('Fixed Amount') }}" min="0" step="0.01" value="">
            </div>
            ...
            <div class="row d-none" id="Range">
                <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="min_amount" name="min_amount" placeholder="{{ __('Minimum Amount') }}" min="0" step="0.01" value="">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="max_amount" name="max_amount" placeholder="{{ __('Maximum Amount') }}" min="0" step="0.01" value="">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="inp-percentage" name="profit_percentage"  placeholder="{{ __('Enter Return Percentage') }}" min="0" step="0.01" value="" required>
            </div>
